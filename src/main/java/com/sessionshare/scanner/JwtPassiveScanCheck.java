...
/**
 * JWT passive scan check.
 *
 * Flags alg:none, HS256, missing expiry, expired tokens accepted, and sensitive data in payload.
 */
public class JwtPassiveScanCheck implements ScanCheck {
    ...
    public AuditResult activeAudit(HttpRequestResponse baseRequestResponse,
        ...
        // Active JWT attacks removed — this scan check is passive-only.
